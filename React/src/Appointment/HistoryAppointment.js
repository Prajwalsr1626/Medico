...
export default class HistoryAppointment extends React.Component{
    ...
    componentDidMount(){
      ...
      fetch(`http://localhost:8080/Hospital/getAppointvited/${this.props.Hosdata}`)
   ...
   refresh(){
    ...
    render(){
        ...
        return(
            ...
            <div class="tab-pane fade" id="hisAppoint" role="tabpanel" aria-labelledby="Consultancy-list">
